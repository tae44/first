...
class RestMixin:
    ...
    def _handle_request_exception(self, e):
        ...
        self.jsonify(code=e.status_code, message=str(e), excption=e.__class__)


class WatchHandler(RequestHandler, RestMixin):
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            self.jsonify(code=200, message='{} added'.format(payload['filename']))
        except KeyError:
    ...
    def delete(self, *args, **kwargs):
        ...
        try:
            ...
            logging.info(path)
            self.application.zk.delete(path, recursive=recursive)
            self.jsonify(code=200, message='{} deleted'.format(self.get_argument('filename')))
        except NoNodeError:
            raise HTTPError(404, reason='{} not found'.format(self.get_argument('filename')))
        except Exception as e:
            raise HTTPError(500, log_message=str(e), reason=str(e))
